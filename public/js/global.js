...
export function tsFetch(option) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            sentData = function () { return __awaiter(_this, void 0, void 0, function () {
                var formData_1, response, msgResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(formElement != undefined && formElement.reportValidity())) return [3 /*break*/, 3];
                            formData_1 = new FormData(formElement);
                            if (option.postData) {
                                Object.entries(option.postData).forEach(function (_a) {
